...
<body>
    <section>
            ...
            if(isset($_SESSION["usuario"])){
                if ($_SESSION["usuario"]["cargo_usuario"] == 1) {
                    include_once('../G/encabezado.php'); 
                }elseif ($_SESSION["usuario"]["cargo_usuario"] == 2) {
                    include_once('../V/encabezado.php');
                }elseif ($_SESSION["usuario"]["cargo_usuario"] == 3) {
                    include_once('../T/encabezado.php');
                }
            }
            ?>                    
            ...
            if(isset($_SESSION["usuario"])){
                if ($_SESSION["usuario"]["cargo_usuario"] == 1) {?>
                    <h2>Bienvenid@ Gerente</h2>
                    <p>Crea y administra tu empresa facilmente</p>
<?php
                }elseif ($_SESSION["usuario"]["cargo_usuario"] == 2) {?>
                    <h2>Bienvenid@ Vendedor</h2>
                    <p>Lleva el registro de tus ventas</p>
<?php                }elseif ($_SESSION["usuario"]["cargo_usuario"] == 3) {?>
                            <h2>Bienvenid@ Tecnico</h2>
